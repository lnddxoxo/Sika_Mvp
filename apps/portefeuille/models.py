...
TYPE = [('achat','Achat'),('vente','Vente')]
ORDRE = [('marche','Au marché'),('limite','À cours limité')]
ticker = models.CharField(max_length=10)
type_transaction = models.CharField(max_length=10, choices=TYPE)
type_ordre = models.CharField(max_length=10, choices=ORDRE, default="marche")
...
stop_loss = models.DecimalField(max_digits=12, decimal_places=2, null=True)
objectif_1 = models.DecimalField(max_digits=12, decimal_places=2, null=True)
objectif_2 = models.DecimalField(max_digits=12, decimal_places=2, null=True)
objectif_3 = models.DecimalField(max_digits=12, decimal_places=2, null=True)
